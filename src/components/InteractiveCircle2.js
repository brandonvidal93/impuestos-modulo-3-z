...
class InteractiveCircle2 extends Component {
  ...
  render() {
    ...
    return (
      <div className = 'interactiveCircle2 bg-particles-2'>
        {
          // MOSTRAR LOS GLOBOS DE TEXTO
          this.state.openGlobe !== false ?
          <div className = 'bgItemGlobe'>
            <div
              className = { 'itemGlobe animated dF-C-cs ' + (multimediaCircular[actualItem - 1].itemInfo.posTriang)}
              ...
              <h3 className = 'mB-05'>{ multimediaCircular[actualItem - 1].itemInfo.title }</h3>
